const Footer = () => {
  return (
    <div className="bg-neutral text-neutral-content">
      <footer className="footer p-6 lg:p-10 border-b-2 w-10/12 mx-auto">
        <aside>
          ...
          <p>
            Explore the flavors of the world with Meal Maestro Restaurant, where
            every dish is a culinary journey.
          </p>
        </aside>
        <nav>
